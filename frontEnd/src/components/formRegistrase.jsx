    ...
    <>
      <Form>
			<Form.Group className="mb-3" controlId="formPlaintextUsuario">
				...
				<Form.Control type="text" rows={3} placeholder="@TimmyTurrner" />
			</Form.Group>
			<Form.Group className="mb-3" controlId="formPlaintextEmail">
				<Form.Label>Email</Form.Label>
				<Form.Control type="email" rows={3} placeholder="email@example.com" />
			</Form.Group>
			...
			<Form.Group className="mb-3" controlId="formPlaintextPassword">
				...
				<Form.Control type="text" rows={3} placeholder="contraseña" />
			</Form.Group>
